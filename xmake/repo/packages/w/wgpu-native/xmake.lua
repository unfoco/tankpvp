package("wgpu-native")
    ...
    elseif is_plat("android") and is_arch("arm64-v8a") then
        add_urls("https://github.com/gfx-rs/wgpu-native/releases/download/$(version)/wgpu-android-aarch64-release.zip", {version = function(version) return version:gsub("%+", ".") end})
        add_versions("v27.0.4+0", "80a93ecfcb14d07f6cadb8bc9bdcf78974f3668b27a89f52a1b006cd14e985a0")
    ...
    on_load(function (package)
        ...
        elseif package:is_plat("android") then
            if not package:config("shared") then
                package:add("syslinks", "dl", "log", "android")
            end
    ...
    on_install("windows", "mingw|x86_64", "linux", "macosx", "android|arm64-v8a", function (package)
        ...
        elseif package:is_plat("linux") or package:is_plat("android") then
            if package:config("shared") then
