...
static auto is_internal_component(const std::string& name) -> bool {
    static const std::unordered_set<std::string> internal = {
        ...
        "ScriptState", "ServerClock", "Settings", "SimulationClock", "Sprite", "SpritePart",
        "RenderState", "EmitterState", "MinimapHandle", "InterfaceState",
    };
...
auto Reflect::engine_enums() -> const std::vector<EngineEnum>& {
    static const std::vector<EngineEnum> ENUMS = {
        {"BlendMode", {{"Normal", static_cast<int>(BlendMode::Normal)},
                       ...
                       {"Subtract", static_cast<int>(BlendMode::Subtract)}}},
        {"RenderPlane", {{"Background", plane::Background.value},
                         {"Floor", plane::Floor.value},
                         {"Decal", plane::Decal.value},
                         {"Entity", plane::Entity.value},
                         {"Overhead", plane::Overhead.value},
                         {"Foreground", plane::Foreground.value}}},
        {"ScreenTransition", {{"Fade", static_cast<int>(ScreenTransitionKind::Fade)},
                              {"Slide", static_cast<int>(ScreenTransitionKind::Slide)},
                              {"Dissolve", static_cast<int>(ScreenTransitionKind::Dissolve)},
                              {"Pixelate", static_cast<int>(ScreenTransitionKind::Pixelate)},
                              {"Circle", static_cast<int>(ScreenTransitionKind::Circle)}}},
