...
private:
    ...
    static void sync(const B2Body&, const LinearVelocity&, const AngularVelocity&);
    ...
    static void velocity(const B2Body&, LinearVelocity&, AngularVelocity&);
    ...
    static void ldamp(const B2Body&, const LinearDamping&);
    static void adamp(const B2Body&, const AngularDamping&);
};
